...
export default function DashboardLayout({ children }) {
  ...
  const MERCHANT_NAV = [
    { href: '/dashboard/merchant',           icon: LayoutDashboard, label: t('merchant_dashboard') },
    { href: '/dashboard/merchant/offers',    icon: Package,         label: t('merchant_offers') },
    { href: '/dashboard/merchant/create',    icon: Plus,            label: t('merchant_create') },
    { href: '/dashboard/merchant/profile',   icon: Store,           label: t('merchant_profile') },
    { href: '/dashboard/merchant/stats',     icon: BarChart2,       label: t('merchant_stats') },
    { href: '/dashboard/merchant/qrcode',    icon: QrCode,          label: t('merchant_qrcode') },
    { href: '/dashboard/merchant/settings',  icon: Settings,        label: t('merchant_settings') },
  ];

  const CLIENT_NAV = [
    { href: '/dashboard/client',               icon: LayoutDashboard, label: t('client_dashboard') },
    { href: '/dashboard/client/favorites',     icon: Heart,           label: t('client_favorites') },
    { href: '/dashboard/client/following',     icon: Users,           label: t('client_following') },
    { href: '/dashboard/client/notifications', icon: Bell,            label: t('client_notifications') },
    { href: '/dashboard/client/profile',       icon: User,            label: t('client_profile') },
    { href: '/dashboard/client/settings',      icon: Settings,        label: t('client_settings') },
  ];

  const ADMIN_NAV = [
    { href: '/dashboard/admin',            icon: LayoutDashboard, label: t('admin_dashboard') },
    { href: '/dashboard/admin/users',      icon: Users,           label: t('admin_users') },
    { href: '/dashboard/admin/merchants',  icon: Store,           label: t('admin_merchants') },
    { href: '/dashboard/admin/offers',     icon: Package,         label: t('admin_offers') },
    { href: '/dashboard/admin/reports',    icon: Flag,            label: t('admin_reports') },
    { href: '/dashboard/admin/stats',      icon: BarChart2,       label: t('admin_stats') },
    { href: '/dashboard/admin/settings',   icon: Settings,        label: t('admin_settings') },
  ];
