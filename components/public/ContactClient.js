              ...
              {sent ? (
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                  ...
                  <div>
                    ...
                    <input value={form.productInterest} onChange={e => setForm(p => ({ ...p, productInterest: e.target.value }))}
            ...
            <div className="lg:col-span-2 flex flex-col gap-6">
              {contactItems.length > 0 && (
                <div className="p-8 rounded-sm border border-[var(--border)] bg-[var(--card)]">
                  <h3 className="font-display font-bold text-lg mb-6" style={{ color: 'var(--foreground)' }}>Informations</h3>
                  ...
                  {s.company_phone && (
                    <a href={`tel:${s.company_phone.replace(/\s/g, '')}`}
              ...
              {s.maps_url && (
                <div className="rounded-sm overflow-hidden border border-[var(--border)]" style={{ height: '240px' }}>
                  <iframe src={s.maps_url} className="w-full h-full" style={{ border: 0 }} allowFullScreen loading="lazy" title="Localisation" />
                </div>
              )}
            </div>
          </div>
